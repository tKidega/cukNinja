...
<div class='container' id='def_login'>
  ...
  <div id='dataSummary'>
    <h3 class='main2Title'>cukNinja-Farmer administrator</h3>
    @include('scripts.content.farmer.admin.mainContent')
  </div>
  <div style='clear:both'></div>

  <div id='sysLogin'>
    <h3 class='main2Title'>controllPanel</h3>
    @include('scripts.content.farmer.admin.controllPanel')
  </div>
  <div style='clear:both'></div>
